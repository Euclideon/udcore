...
/* Disable the littany of warnings */
#pragma warning (disable: 4127) // condition expression is constant
#pragma warning (disable: 4244) // conversion from 'uint64_t' to 'unsigned int', possible loss of data
...
#pragma warning (disable: 4703) // potentially uninitialized local variable used
#include <stdlib.h>
