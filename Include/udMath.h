...
float udSinh(float f);
double udSinh(double d);
float udCosh(float f);
double udCosh(double d);
float udTanh(float f);
double udTanh(double d);
...
float udASinh(float f);
double udASinh(double d);
float udACosh(float f);
double udACosh(double d);
...
template <typename T>
constexpr bool udArrayIsFinite(const T *pArr, size_t n)
{
...
constexpr bool udArrayIsFinite(T (&arr)[N]) { return udArrayIsFinite(arr, N); }

// rounding functions
float udRound(float f);
double udRound(double d);
template <typename T>
udVector2<T> udRound(const udVector2<T> &v);
template <typename T>
udVector3<T> udRound(const udVector3<T> &v);
template <typename T>
udVector4<T> udRound(const udVector4<T> &v);

float udFloor(float f);
double udFloor(double d);
template <typename T>
udVector2<T> udFloor(const udVector2<T> &v);
template <typename T>
udVector3<T> udFloor(const udVector3<T> &v);
template <typename T>
udVector4<T> udFloor(const udVector4<T> &v);

float udCeil(float f);
double udCeil(double d);
template <typename T>
udVector2<T> udCeil(const udVector2<T> &v);
template <typename T>
udVector3<T> udCeil(const udVector3<T> &v);
template <typename T>
udVector4<T> udCeil(const udVector4<T> &v);
...
template <typename T>
T udMaxElement(const udVector2<T> &v);
template <typename T>
T udMaxElement(const udVector3<T> &v);
template <typename T>
T udMaxElement(const udVector4<T> &v);
template <typename T>
...
template <typename T>
T udMinElement(const udVector2<T> &v);
template <typename T>
T udMinElement(const udVector3<T> &v);
template <typename T>
T udMinElement(const udVector4<T> &v);
template <typename T>
...
template <typename T>
udVector2<T> udSaturate(const udVector2<T> &v);
template <typename T>
udVector3<T> udSaturate(const udVector3<T> &v);
template <typename T>
udVector4<T> udSaturate(const udVector4<T> &v);

template <typename V, typename T>
bool udIsUnitLength(const V &v, T epsilon = UD_EPSILON);

template <typename T>
T udDot(const udVector2<T> &v1, const udVector2<T> &v2);
template <typename T>
T udDot(const udVector3<T> &v1, const udVector3<T> &v2);
template <typename T>
T udDot(const udVector4<T> &v1, const udVector4<T> &v2);
template <typename T>
T udDot(const udQuaternion<T> &q1, const udQuaternion<T> &q2);

template <typename T>
T udDot2(const udVector2<T> &v1, const udVector2<T> &v2);
template <typename T>
T udDot2(const udVector3<T> &v1, const udVector3<T> &v2);
template <typename T>
T udDot2(const udVector4<T> &v1, const udVector4<T> &v2);
template <typename T>
T udDot3(const udVector3<T> &v1, const udVector3<T> &v2);
template <typename T>
T udDot3(const udVector4<T> &v1, const udVector4<T> &v2);
template <typename T>
T udDot4(const udVector4<T> &v1, const udVector4<T> &v2);
template <typename T>
T udDoth(const udVector3<T> &v3, const udVector4<T> &v4);
template <typename T>
T udDotQ(const udQuaternion<T> &q1, const udQuaternion<T> &q2);

template <typename T>
T udMagSq(const udVector2<T> &v);
template <typename T>
T udMagSq(const udVector3<T> &v);
template <typename T>
T udMagSq(const udVector4<T> &v);
template <typename T>
T udMagSq(const udQuaternion<T> &q);

template <typename T>
T udMagSq2(const udVector2<T> &v);
template <typename T>
T udMagSq2(const udVector3<T> &v);
template <typename T>
T udMagSq2(const udVector4<T> &v);
template <typename T>
T udMagSq3(const udVector3<T> &v);
template <typename T>
T udMagSq3(const udVector4<T> &v);
template <typename T>
T udMagSq4(const udVector4<T> &v);
template <typename T>
T udMagSqQ(const udQuaternion<T> &q);

template <typename T>
T udMag(const udVector2<T> &v);
template <typename T>
T udMag(const udVector3<T> &v);
template <typename T>
T udMag(const udVector4<T> &v);
template <typename T>
T udMag(const udQuaternion<T> &v);

template <typename T>
T udMag2(const udVector2<T> &v);
template <typename T>
T udMag2(const udVector3<T> &v);
template <typename T>
T udMag2(const udVector4<T> &v);
template <typename T>
T udMag3(const udVector3<T> &v);
template <typename T>
T udMag3(const udVector4<T> &v);
template <typename T>
T udMag4(const udVector4<T> &v);
template <typename T>
T udMagQ(const udQuaternion<T> &v);

template <typename T>
T udCross(const udVector2<T> &v1, const udVector2<T> &v2);
template <typename T>
udVector3<T> udCross(const udVector3<T> &v1, const udVector3<T> &v2);

template <typename T>
T udCross2(const udVector2<T> &v1, const udVector2<T> &v2);
template <typename T>
T udCross2(const udVector3<T> &v1, const udVector3<T> &v2);
template <typename T>
T udCross2(const udVector4<T> &v1, const udVector4<T> &v2);
template <typename T>
...
template <typename T>
udVector2<T> udNormalize(const udVector2<T> &v);
template <typename T>
udVector3<T> udNormalize(const udVector3<T> &v);
template <typename T>
udVector4<T> udNormalize(const udVector4<T> &v);
template <typename T>
udQuaternion<T> udNormalize(const udQuaternion<T> &q);
...
template <typename T>
udQuaternion<T> udNormalizeQ(const udQuaternion<T> &q);
...
template <typename T>
udQuaternion<T> udSlerp(const udQuaternion<T> &q1, const udQuaternion<T> &q2, double t);

template <typename V>
bool udEqualApprox(const V &a, const V &b, typename V::ElementType epsilon = UD_EPSILON);
template <typename T>
bool udMatrixEqualApprox(const udMatrix4x4<T> &a, const udMatrix4x4<T> &b, T epsilon = (T)(UD_EPSILON));
...
struct udVector2
{
  ...
  udVector2<T> operator+(const udVector2<T> &v) const
  {
    udVector2<T> r = { x + v.x, y + v.y };
    return r;
  }
  udVector2<T> operator-(const udVector2<T> &v) const
  {
  ...
  template <typename U>
  udVector2<T> operator*(U f) const
  {
    udVector2<T> r = { T(x * f), T(y * f) };
    return r;
  }
  udVector2<T> operator/(const udVector2<T> &v) const
  {
  ...
  udVector2<T> &operator+=(const udVector2<T> &v)
  {
    x += v.x;
    y += v.y;
    return *this;
  ...
  // static members
  static udVector2<T> zero()
  {
    udVector2<T> r = { T(0), T(0) };
    return r;
  }
  static udVector2<T> one()
  {
    udVector2<T> r = { T(1), T(1) };
    return r;
  }

  static udVector2<T> xAxis()
  {
    udVector2<T> r = { T(1), T(0) };
    return r;
  }
  static udVector2<T> yAxis()
  {
    udVector2<T> r = { T(0), T(1) };
    return r;
  }

  static udVector2<T> create(T _f)
  {
    udVector2<T> r = { _f, _f };
    return r;
  }
  static udVector2<T> create(T _x, T _y)
  {
    udVector2<T> r = { _x, _y };
    return r;
  }
  template <typename U>
  static udVector2<T> create(const udVector2<U> &_v)
  {
    udVector2<T> r = { T(_v.x), T(_v.y) };
    return r;
  }
};
template <typename T>
...
struct udVector3
{
  ...
  udVector3<T> operator+(const udVector3<T> &v) const
  {
    udVector3<T> r = { x + v.x, y + v.y, z + v.z };
    return r;
  }
  udVector3<T> operator-(const udVector3<T> &v) const
  {
  ...
  template <typename U>
  udVector3<T> operator*(U f) const
  {
    udVector3<T> r = { T(x * f), T(y * f), T(z * f) };
    return r;
  }
  udVector3<T> operator/(const udVector3<T> &v) const
  {
  ...
  udVector3<T> &operator+=(const udVector3<T> &v)
  {
    x += v.x;
    y += v.y;
    z += v.z;
  ...
  // static members
  static udVector3<T> zero()
  {
    udVector3<T> r = { T(0), T(0), T(0) };
    return r;
  }
  static udVector3<T> one()
  {
    udVector3<T> r = { T(1), T(1), T(1) };
    return r;
  }

  static udVector3<T> create(T _f)
  {
    udVector3<T> r = { _f, _f, _f };
    return r;
  }
  static udVector3<T> create(T _x, T _y, T _z)
  {
    udVector3<T> r = { _x, _y, _z };
    return r;
  }
  static udVector3<T> create(const udVector2<T> _v, T _z)
  {
    udVector3<T> r = { _v.x, _v.y, _z };
    return r;
  }
  template <typename U>
  static udVector3<T> create(const udVector3<U> &_v)
  {
    udVector3<T> r = { T(_v.x), T(_v.y), T(_v.z) };
    return r;
  }
};
template <typename T>
...
struct udVector4
{
  ...
  udVector4<T> operator-() const
  {
    udVector4<T> r = { -x, -y, -z, -w };
    return r;
  }
  ...
  udVector4<T> operator+(const udVector4<T> &v) const
  {
    udVector4<T> r = { x + v.x, y + v.y, z + v.z, w + v.w };
    return r;
  }
  udVector4<T> operator-(const udVector4<T> &v) const
  {
  ...
  template <typename U>
  udVector4<T> operator*(U f) const
  {
    udVector4<T> r = { T(x * f), T(y * f), T(z * f), T(w * f) };
    return r;
  }
  udVector4<T> operator/(const udVector4<T> &v) const
  {
  ...
  udVector4<T> &operator+=(const udVector4<T> &v)
  {
    x += v.x;
    y += v.y;
    z += v.z;
  ...
  // static members
  static udVector4<T> zero()
  {
    udVector4<T> r = { T(0), T(0), T(0), T(0) };
    return r;
  }
  static udVector4<T> one()
  {
    udVector4<T> r = { T(1), T(1), T(1), T(1) };
    return r;
  }
  static udVector4<T> identity()
  {
    udVector4<T> r = { T(0), T(0), T(0), T(1) };
    return r;
  }

  static udVector4<T> create(T _f)
  {
    udVector4<T> r = { _f, _f, _f, _f };
    return r;
  }
  static udVector4<T> create(T _x, T _y, T _z, T _w)
  {
    udVector4<T> r = { _x, _y, _z, _w };
    return r;
  }
  static udVector4<T> create(const udVector3<T> &_v, T _w)
  {
    udVector4<T> r = { _v.x, _v.y, _v.z, _w };
    return r;
  }
  static udVector4<T> create(const udVector2<T> &_v, T _z, T _w)
  {
    udVector4<T> r = { _v.x, _v.y, _z, _w };
    return r;
  }
  template <typename U>
  static udVector4<T> create(const udVector4<U> &_v)
  {
    udVector4<T> r = { T(_v.x), T(_v.y), T(_v.z), T(_v.w) };
    return r;
  }
};
template <typename T, typename U>
...
struct udQuaternion
{
  ...
  udQuaternion<T> operator-() const
  {
    udQuaternion<T> r = { -x, -y, -z, -w };
    return r;
  }
  udQuaternion<T> operator+(const udQuaternion<T> &q) const
  {
    udQuaternion<T> r = { x + q.x, y + q.y, z + q.z, w + q.w };
    return r;
  }
  udQuaternion<T> operator-(const udQuaternion<T> &q) const
  {
  ...
  template <typename U>
  udQuaternion<T> operator*(U f) const
  {
    udQuaternion<T> r = { T(x * f), T(y * f), T(z * f), T(w * f) };
    return r;
  }
  T operator[](size_t index) const { return ((T *)this)[index]; }

  udQuaternion<T> &operator*=(const udQuaternion<T> &q)
  {
    *this = udMul(*this, q);
    return *this;
  }
  template <typename U>
  udQuaternion<T> &operator*=(U f)
  {
    x = T(x * f);
    y = T(y * f);
    z = T(z * f);
  ...
  // static members
  static udQuaternion<T> zero()
  {
    udQuaternion<T> q = { T(0), T(0), T(0), T(0) };
    return q;
  }
  static udQuaternion<T> identity()
  {
    udQuaternion<T> q = { T(0), T(0), T(0), T(1) };
    return q;
  }
  ...
  template <typename U>
  static udQuaternion<T> create(const udQuaternion<U> &_q)
  {
    udQuaternion<T> r = { T(_q.x), T(_q.y), T(_q.z), T(_q.w) };
    return r;
  }
};
template <typename T, typename U>
...
struct udRay
{
  ...
  // static members
  static udRay<T> create(const udVector3<T> &position, const udVector3<T> &direction)
  {
    udRay<T> r = { position, direction };
    return r;
  }

  template <typename U>
  static udRay<T> create(const udRay<U> &_v)
  {
    udRay<T> r = { udVector3<T>::create(_v.position), udVector3<T>::create(_v.direction) };
    return r;
  }
...
struct udPlane
{
  ...
  // static members
  static udPlane<T> create(const udVector3<T> &position, const udVector3<T> &normal)
  {
    udPlane<T> r = { position, normal };
    return r;
  }
  template <typename U>
  static udPlane<T> create(const udPlane<U> &_v)
  {
    udPlane<T> r = { udVector3<T>::create(_v.point), udVector3<T>::create(_v.normal) };
    return r;
  }
};
...
struct udMatrix4x4
{
  ...
  udMatrix4x4<T> &operator+=(const udMatrix4x4<T> &m2)
  {
    *this = udAdd(*this, m2);
    return *this;
  }
