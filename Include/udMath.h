...
float udASinh(float y, float x);
double udASinh(double y, double x);
float udACosh(float y, float x);
double udACosh(double y, double x);
float udATan(float f);
double udATan(double d);
float udATanh(float y, float x);
double udATanh(double y, double x);
