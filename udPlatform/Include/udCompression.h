...
enum udCompressionType
{
  ...
  udCT_Deflate, // Zip style compression

  udCT_Count
};

// Compress a buffer, providing an allocate buffer of the compressed data
udResult udCompression_Deflate(void **ppDest, size_t *pDestSize, const void *pSource, size_t sourceSize, udCompressionType type = udCT_Deflate);
...
udResult udCompression_Inflate(void *pDest, size_t destSize, const void *pSource, size_t sourceSize, size_t *pInflatedSize = nullptr, udCompressionType type = udCT_Deflate);
