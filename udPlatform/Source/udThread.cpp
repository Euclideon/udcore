...
#if UDPLATFORM_LINUX || UDPLATFORM_NACL || UDPLATFORM_OSX || UDPLATFORM_IOS_SIMULATOR || UDPLATFORM_IOS
#include <sched.h>
#include <pthread.h>
#include <errno.h>
#include <semaphore.h>
...
#elif UDPLATFORM_NACL || UDPLATFORM_OSX || UDPLATFORM_IOS_SIMULATOR || UDPLATFORM_IOS
    udUnused(priority);
#else
#   error Unknown platform
#endif
